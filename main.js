...
function updateCanvas() {
    random_num = Math.floor(quick_draw_data_set.length - 1);
    console.log(quick_draw_data_set[random_num]);
    sketch_to_be_drawn = quick_draw_data_set[random_num];
    document.getElementById("name_of_sketch").innerHTML = "You will draw " + sketch_to_be_drawn;
}

function check_sketch() {
    timer_counter = timer_counter + 1;
    document.getElementById("time_left") = "Time left : " + timer_counter;
